...
public class GlobalExceptionHandler {
     ...
     */
    @ExceptionHandler(com.example.zdnl7.config.exception.CommonJsonException.class)
     ...
     */
    @ExceptionHandler(com.example.zdnl7.config.exception.UnauthenticatedException.class)
